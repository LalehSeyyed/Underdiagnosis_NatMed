...
mkdir('./results_Label15/')    

# For results on 14 labels
Run1_sex = pd.read_csv("./results33/Run155_sex.csv")
Run2_sex = pd.read_csv("./results96/Run155_sex.csv")
Run3_sex = pd.read_csv("./results60/Run155_sex.csv")
Run4_sex = pd.read_csv("./results37/Run155_sex.csv")
Run5_sex = pd.read_csv("./results3/Run155_sex.csv")
...
WantX.to_csv("./results_Label15/WantX.csv")
...
plt.legend()
plt.grid(True)
plt.savefig("./results_Label15/SEX_NIH.pdf")
#
# #---------------------------------------------------   Age



Run1_Age = pd.read_csv("./results33/Run155_Age.csv")
Run2_Age = pd.read_csv("./results96/Run155_Age.csv")
Run3_Age = pd.read_csv("./results60/Run155_Age.csv")
Run4_Age = pd.read_csv("./results37/Run155_Age.csv")
Run5_Age = pd.read_csv("./results3/Run155_Age.csv")
...
WantAge.to_csv("./results_Label15/WantAge.csv")
...
plt.legend()
plt.grid(True)
plt.savefig("./results_Label15/AGE_NIH.pdf")
