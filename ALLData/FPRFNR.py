...
def FPFN_NF_CXP(TrueWithMeta_df, df, diseases, category, category_name):
   # return FPR and FNR per subgroup and the unber of patients with 0 No-finding in test set.
   
    df = df.merge(TrueWithMeta_df, left_on="Jointpath", right_on="Jointpath")
    ...
    print("FP and FNR and #of negative and #of positive NF in CXP")
...
def FPFN_NF_CXP_Inter(TrueWithMeta_df, df, diseases, category1, category_name1,category2, category_name2 ):
...
def FP_NF_CXP_MEMBERSHIP_Num_Inter(TrueWithMeta_df, df, diseases, category1, category_name1,category2, category_name2 ):
...
def FN_NF_CXP_MEMBERSHIP_Num_Inter(TrueWithMeta_df, df, diseases, category1, category_name1,category2, category_name2 ):
    df = df.merge(TrueWithMeta_df, left_on="Jointpath", right_on="Jointpath")
...
#--------------------------------------------------------------     
    ...
    FPFN_NF_CXP(TrueWithMeta, pred, diseases, Age, 'Age')

    FPFN_NF_CXP(TrueWithMeta, pred, diseases, Sex, 'Sex')
    

#--------------------------------------------------------------    
#     #Intersectional-specific Chronic Underdiagnosis
#--------------------------------------------------------------
    FPFN_NF_CXP_Inter(TrueWithMeta, pred, diseases, Sex, 'Sex',Age,'Age')
#--------------------------------------------------------------    
#     #Intersectional Membership FN_NF_CXP_MEMBERSHIP_Num_Inter
#-------------------------------------------------------------- 

    FP_NF_CXP_MEMBERSHIP_Num_Inter(TrueWithMeta, pred, diseases, Sex, 'Sex', Age, 'Age')

    FN_NF_CXP_MEMBERSHIP_Num_Inter(TrueWithMeta, pred, diseases, Sex, 'Sex', Age, 'Age')
